...
# 读取 diff 文件
with open("/root/dataMining/lastweek/data/wine/meta_data/wine.diff.csv","r",encoding='utf-8-sig') as fulldata:
...
pd_fulldata = pd.read_csv("/root/dataMining/lastweek/data/wine/meta_data/wine.diff.csv")
pd_fulldata.head(10)
...
# 组织特征和标签信息
fulldata = pd_fulldata[["fixed.acidity","volatile.acidity","citric.acid","residual.sugar","chlorides","free.sulfur.dioxide","total.sulfur.dioxide","density","pH","sulphates","alcohol"]]
...
# 准备输出文件
outputfile = open("winediffResults.txt", "w")
...
benchmarkFileBaseName = "/root/dataMining/lastweek/data/wine/benchmarks/wine_benchmark_"
benchmarkFileNumber = 1680
benchmarkCurrenFile = 1607
timebar = tqdm(range(benchmarkFileNumber-benchmarkCurrenFile))

# 准备输出文件
outputfile = open("wineBenchmarkResults.txt", "w")
...
for item in timebar:
    ...
    benchmarkdata = benchmark_data[["fixed.acidity","volatile.acidity","citric.acid","residual.sugar","chlorides","free.sulfur.dioxide","total.sulfur.dioxide","density","pH","sulphates","alcohol"]]
